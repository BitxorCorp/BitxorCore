...
(function prepareDbCollections() {
	...
	['addressResolutionStatements', 'tokenResolutionStatements'].forEach(collectionName => {
		db.createCollection(collectionName);
...
(function preparePluginDbCollections() {
	const pluginNames = [
		'LockHash', 'LockSecret', 'Metadata', 'Token', 'Multisig', 'Namespace', 'RestrictionAccount', 'RestrictionToken'
	];
