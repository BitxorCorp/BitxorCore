...
#include "bitxorcore/io/BlockStorageChangeSubscriber.h"
...
namespace bitxorcore { namespace mongo {
	...
	namespace {
		...
		void RegisterExtension(extensions::ProcessBootstrapper& bootstrapper) {
			...
			// add a pre load handler for initializing (genesis) storage
...
void RegisterExtension(bitxorcore::extensions::ProcessBootstrapper& bootstrapper) {
	bitxorcore::mongo::RegisterExtension(bootstrapper);
}
