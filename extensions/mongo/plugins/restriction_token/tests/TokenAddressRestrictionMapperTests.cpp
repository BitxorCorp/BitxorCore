...
#include "src/TokenAddressRestrictionMapper.h"
...
#define TEST_CLASS TokenAddressRestrictionMapperTests

	namespace {
		DEFINE_MONGO_TRANSACTION_PLUGIN_TEST_TRAITS_NO_ADAPT(TokenAddressRestriction,)
	}

	DEFINE_BASIC_MONGO_EMBEDDABLE_TRANSACTION_PLUGIN_TESTS(TEST_CLASS, , , model::Entity_Type_Token_Address_Restriction)

	// region streamTransaction

	PLUGIN_TEST(CanMapTokenAddressRestrictionTransaction) {
		// Arrange:
