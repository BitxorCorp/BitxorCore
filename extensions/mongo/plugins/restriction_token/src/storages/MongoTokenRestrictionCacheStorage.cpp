...
#include "MongoTokenRestrictionCacheStorage.h"
...
namespace bitxorcore { namespace mongo { namespace plugins {
	...
	namespace {
		struct TokenRestrictionCacheTraits : public storages::BasicMongoCacheStorageTraits<cache::TokenRestrictionCacheDescriptor> {
			static constexpr auto Collection_Name = "tokenRestrictions";
			static constexpr auto Id_Property_Name = "tokenRestrictionEntry.compositeHash";
	...
	DEFINE_MONGO_FLAT_CACHE_STORAGE(TokenRestriction, TokenRestrictionCacheTraits)
}}}
