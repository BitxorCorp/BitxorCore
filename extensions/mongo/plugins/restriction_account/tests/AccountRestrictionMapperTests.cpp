...
#define DEFINE_ACCOUNT_RESTRICTION_MAPPER_TESTS_WITH_PREFIXED_TRAITS(TRAITS, PREFIX, RESTRICTION_VALUE_TRAITS) \
	...
	namespace {
		...
		DEFINE_MONGO_TRANSACTION_PLUGIN_TEST_TRAITS_NO_ADAPT(AccountTokenRestriction, Token)
	...
	DEFINE_BASIC_MONGO_EMBEDDABLE_TRANSACTION_PLUGIN_TESTS(TEST_CLASS, Token, _Token, model::Entity_Type_Account_Token_Restriction)
	...
	DEFINE_ACCOUNT_RESTRICTION_MAPPER_TESTS_WITH_PREFIXED_TRAITS(Traits, Token, test::BaseAccountTokenRestrictionTraits)
