...
void RegisterMongoSubsystem(bitxorcore::mongo::MongoPluginManager& manager) {
	// transaction support
	manager.addTransactionSupport(bitxorcore::mongo::plugins::CreateMultisigAccountModificationTransactionMongoPlugin());

	// cache storage support
	manager.addStorageSupport(bitxorcore::mongo::plugins::CreateMongoMultisigCacheStorage(
