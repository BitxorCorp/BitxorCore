...
namespace bitxorcore { namespace mongo { namespace mappers {
	...
	namespace {
		...
		bson_stream::array_context& StreamTokenT(bson_stream::array_context& context, TTokenId id, Amount amount) {
			context
	...
	bson_stream::array_context& StreamToken(bson_stream::array_context& context, TokenId id, Amount amount) {
		return StreamTokenT(context, id, amount);
	}

	bson_stream::array_context& StreamToken(bson_stream::array_context& context, UnresolvedTokenId id, Amount amount) {
		return StreamTokenT(context, id, amount);
	}
