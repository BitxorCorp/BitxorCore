...
namespace bitxorcore { namespace test {
	...
	public:
		/// Creates an empty bitxorcore cache with all required sub caches.
		static cache::BitxorCoreCache CreateCache();

		/// Creates a bitxorcore cache with all required sub caches and seed accounts.
		/// \note \a keyPairDescriptors is updated with account information.
		static cache::BitxorCoreCache CreateCache(std::vector<AccountKeyPairDescriptor>& keyPairDescriptors);
