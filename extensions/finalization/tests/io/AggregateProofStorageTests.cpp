	...
	namespace {
		...
		public:
			model::FinalizationStatistics statistics() const override {
				BITXORCORE_THROW_RUNTIME_ERROR("statistics - not supported in mock");
			}

			std::shared_ptr<const model::FinalizationProof> loadProof(FinalizationEpoch) const override {
				BITXORCORE_THROW_RUNTIME_ERROR("loadProof(FinalizationEpoch) - not supported in mock");
			}

			std::shared_ptr<const model::FinalizationProof> loadProof(Height) const override {
				BITXORCORE_THROW_RUNTIME_ERROR("loadProof(Height) - not supported in mock");
			}

			void saveProof(const model::FinalizationProof&) override {
				BITXORCORE_THROW_RUNTIME_ERROR("saveProof - not supported in mock");
			}
		};
