...
#define CONSUMER_HOOK_TEST(TEST_NAME) \
	...
	CONSUMER_HOOK_TEST(CannotSetMultipleTimes) {
		...
		// Act + Assert:
		EXPECT_THROW(TTraits::Set(hooks, [](auto&&) {}), bitxorcore_invalid_argument);
	}
	...
	TEST(TEST_CLASS, LocalFinalizedHeightHashPairSupplierHookIsRegistered_GenesisFinalizedBlockMatches) {
