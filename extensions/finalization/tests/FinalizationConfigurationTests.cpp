...
#define TEST_CLASS FinalizationConfigurationTests
	...
	namespace {
		constexpr auto Address_1 = "TESOAW3EIRSQCILR7RYZWGXNTK6CALKYEPMWB4Y";
		constexpr auto Address_2 = "TESPBNF5DF5TPTZ5AQ6TQBFQDJ5H7RWV3RP6NOI";
		constexpr auto Address_3 = "TESLGVB5ZLPUXTMO3C22YAB6EQSMOKHO2IOHUZI";
	...
	TEST(TEST_CLASS, LoadFromPathFailsWhenFileDoesNotExist) {
		...
		EXPECT_THROW(FinalizationConfiguration::LoadFromPath("../no-resources"), bitxorcore_runtime_error);
	}
