...
namespace bitxorcore { namespace extensions {
	...
	/// Casts \a tokenId to an unresolved token id.
	UnresolvedTokenId CastToUnresolvedTokenId(TokenId tokenId);

	/// Casts \a unresolvedTokenId to a token id.
	TokenId CastToTokenId(UnresolvedTokenId unresolvedTokenId);
