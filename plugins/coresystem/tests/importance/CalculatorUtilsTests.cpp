...
#define TEST_CLASS CalculatorUtilsTests
	...
	TEST(TEST_CLASS, CanSummarizeAccountActivityWhenSomeBucketsArePresentStartingAtSearchHeightExtendingToGenesisHeight) {
		// Arrange:
		state::AccountActivityBuckets buckets;
	...
	TEST(TEST_CLASS, CanSummarizeAccountActivityWhenSomeBucketsArePresentStartingAtSearchHeightExtendingToGenesisHeightWithGaps) {
		// Arrange:
		state::AccountActivityBuckets buckets;
		Set(buckets, model::ImportanceHeight(1), Amount(13), 50, 6);
		Set(buckets, model::ImportanceHeight(40), Amount(11), 70, 2);
	...
	TEST(TEST_CLASS, CanSummarizeAccountActivityWhenSearchHeightIsGenesisHeight) {
		// Arrange:
		state::AccountActivityBuckets buckets;
		Set(buckets, model::ImportanceHeight(1), Amount(13), 50, 6);
	...
	TEST(TEST_CLASS, CanSummarizeAccountActivityWhenPreviousSearchHeightIsGenesisHeight) {
		// Arrange:
		state::AccountActivityBuckets buckets;
		Set(buckets, model::ImportanceHeight(1), Amount(13), 50, 6);
		Set(buckets, model::ImportanceHeight(20), Amount(12), 60, 4);
	...
	TEST(TEST_CLASS, CannotSummarizeAccountActivityGivenImproperSearchHeight) {
		...
		// Act + Assert:
		EXPECT_THROW(SummarizeAccountActivity(model::ImportanceHeight(0), 20, buckets), bitxorcore_invalid_argument);
		EXPECT_THROW(SummarizeAccountActivity(model::ImportanceHeight(219), 20, buckets), bitxorcore_invalid_argument);
		EXPECT_THROW(SummarizeAccountActivity(model::ImportanceHeight(221), 20, buckets), bitxorcore_invalid_argument);
	}
	...
	TEST(TEST_CLASS, CannotSummarizeAccountActivityWhenAnyBucketHasImproperStartHeight) {
		...
		// Act + Assert:
		EXPECT_THROW(SummarizeAccountActivity(model::ImportanceHeight(220), 20, buckets), bitxorcore_invalid_argument);
	}
	...
	TEST(TEST_CLASS, CannotSummarizeAccountActivityWhenAnyBucketHasStartHeightGreaterThanSearchHeight) {
		...
		// Act + Assert:
		EXPECT_THROW(SummarizeAccountActivity(model::ImportanceHeight(180), 20, buckets), bitxorcore_invalid_argument);
	}
	...
	namespace {
		constexpr TokenId Harvesting_Token_Id(9876);
	...
	TEST(TEST_CLASS, StakeImportanceIsAsExpected) {
		...
		accountState.Balances.credit(Harvesting_Token_Id, Amount(500));
		AccountSummary accountSummary(AccountActivitySummary(), accountState);
		ImportanceCalculationContext importanceContext;
		importanceContext.ActiveHarvestingTokens = Amount(1'000);
