...
#define TEST_CLASS BlockTypeValidatorTests
	...
	TEST(TEST_CLASS, HeightOne_MustBeGenesisBlock) {
		AssertValidationResultMultiple(model::Entity_Type_Block_Genesis, 50, Height(1));

		AssertValidationResultMultiple(model::Entity_Type_Block_Genesis, 123, Height(1));
	}
