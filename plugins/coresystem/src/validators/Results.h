...
#define DEFINE_CORE_RESULT(DESCRIPTION, CODE) DEFINE_VALIDATION_RESULT(Failure, Core, DESCRIPTION, CODE, None)
	...
	/// Validation failed because an entity originated from the genesis account after the genesis block.
	DEFINE_CORE_RESULT(Genesis_Account_Signed_After_Genesis_Block, 5);
