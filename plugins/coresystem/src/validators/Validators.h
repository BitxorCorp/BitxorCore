...
namespace bitxorcore { namespace validators {
	...
	/// - genesis account signatures are not allowed after the genesis block unless they are in
	///   \a additionalAllowedSignatures at \a additionalAllowedSignaturesHeight.
	DECLARE_STATEFUL_VALIDATOR(GenesisSink, model::SignatureNotification)(
