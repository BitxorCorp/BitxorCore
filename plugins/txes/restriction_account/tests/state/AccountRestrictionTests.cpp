...
#define TRAITS_BASED_TEST(TEST_NAME) \
	...
	TRAITS_BASED_TEST(CannotAddValueWhenValueSizeIsInvalid) {
		...
		// Act + Assert:
		EXPECT_THROW(TTraits::CanAdd(restriction, test::GenerateRandomVector(Custom_Value_Size - 1)), bitxorcore_invalid_argument);
		EXPECT_THROW(TTraits::CanAdd(restriction, test::GenerateRandomVector(Custom_Value_Size + 1)), bitxorcore_invalid_argument);
	}
	...
	TRAITS_BASED_TEST(CannotRemoveValueWhenValueSizeIsInvalid) {
		...
		// Act + Assert:
		EXPECT_THROW(TTraits::CanRemove(restriction, test::GenerateRandomVector(Custom_Value_Size - 1)), bitxorcore_invalid_argument);
		EXPECT_THROW(TTraits::CanRemove(restriction, test::GenerateRandomVector(Custom_Value_Size + 1)), bitxorcore_invalid_argument);
	}
	...
	TRAITS_BASED_TEST(CannotAddValueWhenValueSizeMismatches) {
		...
		// Act + Assert:
		EXPECT_THROW(TTraits::Add(restriction, test::GenerateRandomVector(Custom_Value_Size + 1)), bitxorcore_invalid_argument);
		EXPECT_THROW(TTraits::Add(restriction, test::GenerateRandomVector(Custom_Value_Size - 1)), bitxorcore_invalid_argument);
	}
	...
	TRAITS_BASED_TEST(CannotRemoveValueWhenValueSizeMismatches) {
		...
		// Act + Assert:
		EXPECT_THROW(TTraits::Remove(restriction, test::GenerateRandomVector(Custom_Value_Size + 1)), bitxorcore_invalid_argument);
		EXPECT_THROW(TTraits::Remove(restriction, test::GenerateRandomVector(Custom_Value_Size - 1)), bitxorcore_invalid_argument);
	}
