...
#define TEST_CLASS MaxAccountRestrictionValuesValidatorTests
	...
	DEFINE_COMMON_VALIDATOR_TESTS(MaxAccountTokenRestrictionValues, 5)
	...
	namespace {
		...
		struct AccountTokenRestrictionTraits : public test::BaseAccountTokenRestrictionTraits {
			static constexpr auto CreateValidator = CreateMaxAccountTokenRestrictionValuesValidator;

			using NotificationType = model::ModifyAccountTokenRestrictionsNotification;
