...
#define TEST_CLASS AccountRestrictionValueModificationValidatorTests
	...
	DEFINE_COMMON_VALIDATOR_TESTS(AccountTokenRestrictionValueModification,)
	...
	namespace {
		...
		struct AccountTokenRestrictionTraits : public test::BaseAccountTokenRestrictionTraits {
			static constexpr auto CreateValidator = CreateAccountTokenRestrictionValueModificationValidator;

			using NotificationType = model::ModifyAccountTokenRestrictionValueNotification;

			static UnresolvedValueType ToUnresolved(const ValueType& value) {
				return extensions::CastToUnresolvedTokenId(value);
			}
		};
...
#define TRAITS_BASED_TEST(TEST_NAME) \
	...
	TEST(TEST_CLASS, TEST_NAME##_Token_Allow) { \
		TRAITS_TEST_NAME(TEST_CLASS, TEST_NAME)<AccountTokenRestrictionTraits, test::AllowTraits>(); \
	} \
	TEST(TEST_CLASS, TEST_NAME##_Token_Block) { \
		TRAITS_TEST_NAME(TEST_CLASS, TEST_NAME)<AccountTokenRestrictionTraits, test::BlockTraits>(); \
	} \
