...
#define TEST_CLASS AccountRestrictionRedundantModificationValidatorTests
	...
	DEFINE_COMMON_VALIDATOR_TESTS(AccountTokenRestrictionRedundantModification,)
	...
	namespace {
		...
		struct AccountTokenRestrictionTraits : public test::BaseAccountTokenRestrictionTraits {
			static constexpr auto CreateValidator = CreateAccountTokenRestrictionRedundantModificationValidator;
