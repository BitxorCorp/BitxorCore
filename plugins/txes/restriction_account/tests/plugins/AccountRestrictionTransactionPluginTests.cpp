...
#define TEST_CLASS AccountRestrictionTransactionPluginTests
	...
	namespace {
		...
		DEFINE_TRANSACTION_PLUGIN_TEST_TRAITS(AccountTokenRestriction, 1, 1, AccountTokenRestriction)
		...
		using TokenRegularTraits = TokenTraits<AccountTokenRestrictionTransaction, AccountTokenRestrictionRegularTraits>;
		using TokenEmbeddedTraits = TokenTraits<EmbeddedAccountTokenRestrictionTransaction, AccountTokenRestrictionEmbeddedTraits>;
	...
	DEFINE_BASIC_EMBEDDABLE_TRANSACTION_PLUGIN_TESTS(TEST_CLASS, Token, _Token, Entity_Type_Account_Token_Restriction)
...
#define DEFINE_ACCOUNT_RESTRICTION_TRANSACTION_PLUGIN_TESTS(TRAITS_PREFIX, TEST_POSTFIX) \
	...
	DEFINE_ACCOUNT_RESTRICTION_TRANSACTION_PLUGIN_TESTS(Token, _Token)
