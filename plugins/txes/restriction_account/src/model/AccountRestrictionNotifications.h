...
#define DEFINE_ACCOUNT_RESTRICTION_NOTIFICATION(DESCRIPTION, CODE, CHANNEL) \
	...
	/// Account token restriction modification.
	DEFINE_ACCOUNT_RESTRICTION_NOTIFICATION(Token_Modification, 0x0003, All);
	...
	/// Account token restriction modifications.
	DEFINE_ACCOUNT_RESTRICTION_NOTIFICATION(Token_Modifications, 0x0006, Validator);
...
#undef DEFINE_ACCOUNT_RESTRICTION_NOTIFICATION
	...
	using ModifyAccountTokenRestrictionValueNotification =
		ModifyAccountRestrictionValueNotification<UnresolvedTokenId, RestrictionAccount_Token_Modification_Notification>;
	...
	using ModifyAccountTokenRestrictionsNotification = ModifyAccountRestrictionsNotification<
		UnresolvedTokenId,
		RestrictionAccount_Token_Modifications_Notification>;
