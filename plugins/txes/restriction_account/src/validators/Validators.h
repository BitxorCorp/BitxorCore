...
#define DECLARE_SHARED_VALIDATORS(VALUE_NAME) \
	...
	DECLARE_SHARED_VALIDATORS(Token)
	...
	/// - the token is allowed to be transferred to the recipient
	DECLARE_STATEFUL_VALIDATOR(TokenRecipient, model::BalanceTransferNotification)();
