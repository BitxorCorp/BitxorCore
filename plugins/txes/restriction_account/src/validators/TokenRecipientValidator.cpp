...
namespace bitxorcore { namespace validators {
	...
	DEFINE_STATEFUL_VALIDATOR(TokenRecipient, [](const Notification& notification, const ValidatorContext& context) {
		...
		auto isTransferAllowed = view.isAllowed(model::AccountRestrictionFlags::TokenId, tokenId);
		return isTransferAllowed ? ValidationResult::Success : Failure_RestrictionAccount_Token_Transfer_Prohibited;
	})
}}
