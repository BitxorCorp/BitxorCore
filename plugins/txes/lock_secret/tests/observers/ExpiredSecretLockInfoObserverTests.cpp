...
#define TEST_CLASS ExpiredSecretLockInfoObserverTests
	...
	TEST(TEST_CLASS, ObserverCreditsAccountsOnCommit_Single) {
		...
		std::vector<SeedTuple> expiringSeeds{
			{ address, TokenId(111), Amount(333), Amount(33) }
		};

		// Act + Assert:
		ObserverTests::RunBalanceTest(NotifyMode::Commit, Harvester_Type, blockHarvesterPublicKey, expiringSeeds, {
			{ address, TokenId(111), Amount(333 + 33), Amount() },
			{ blockHarvester, TokenId(500), Amount(200), Amount() }
		});
	}
	...
	TEST(TEST_CLASS, ObserverCreditsAccountsOnCommit_Multiple) {
		...
		std::vector<SeedTuple> expiringSeeds{
			{ addresses[0], TokenId(111), Amount(333), Amount(33) },
			{ addresses[1], TokenId(222), Amount(222), Amount(88) },
			{ addresses[2], TokenId(111), Amount(444), Amount(44) },
			{ addresses[1], TokenId(222), Amount(), Amount(22) }
		};

		// Act + Assert:
		ObserverTests::RunBalanceTest(NotifyMode::Commit, Harvester_Type, blockHarvesterPublicKey, expiringSeeds, {
			{ addresses[0], TokenId(111), Amount(333 + 33), Amount() },
			{ addresses[1], TokenId(222), Amount(222 + 88 + 22), Amount() },
			{ addresses[2], TokenId(111), Amount(444 + 44), Amount() },
			{ blockHarvester, TokenId(500), Amount(200), Amount() }
		});
	}
	...
	TEST(TEST_CLASS, ObserverCreatesReceiptsOnCommit) {
		...
		std::vector<SeedTuple> expiringSeeds{
			{ Address{ { 9 } }, TokenId(111), Amount(333), Amount(33) },
			{ Address{ { 4 } }, TokenId(222), Amount(222), Amount(88) },
			{ Address{ { 4 } }, TokenId(111), Amount(444), Amount(33) },
			{ Address{ { 9 } }, TokenId(222), Amount(), Amount(22) }
		};
		...
		ObserverTests::RunReceiptTest(NotifyMode::Commit, Harvester_Type, blockHarvesterPublicKey, expiringSeeds, {
			{ Address{ { 4 } }, TokenId(111), Amount(), Amount(33) },
			{ Address{ { 9 } }, TokenId(111), Amount(), Amount(33) },
			{ Address{ { 9 } }, TokenId(222), Amount(), Amount(22) },
			{ Address{ { 4 } }, TokenId(222), Amount(), Amount(88) }
		});
	}
	...
	TEST(TEST_CLASS, ObserverDoesNotCreateReceiptsOnRollback) {
		...
		std::vector<SeedTuple> expiringSeeds{
			{ Address{ { 9 } }, TokenId(111), Amount(333), Amount(33) },
			{ Address{ { 1 } }, TokenId(222), Amount(222), Amount(88) },
			{ Address{ { 4 } }, TokenId(111), Amount(444), Amount(44) },
			{ Address{ { 1 } }, TokenId(222), Amount(), Amount(22) }
		};
