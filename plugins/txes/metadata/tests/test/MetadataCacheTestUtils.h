...
namespace bitxorcore { namespace test {
	...
	/// Cache factory for creating a bitxorcore cache containing at least the metadata cache.
	...
	public:
		...
		static cache::BitxorCoreCache Create(const model::BlockchainConfiguration&) {
			return Create();
		}
	};
}}
