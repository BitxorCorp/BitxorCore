	...
	namespace {
		...
		public:
			...
			static void RunTestAfterRegistration(TAction action) {
				...
				config.Plugins.emplace("bitxorcore.plugins.metadata", utils::ConfigurationBag({{
					"",
					{
						{ "maxValueSize", "10" }
					}
		...
		public:
			static std::vector<model::EntityType> GetTransactionTypes() {
				return { model::Entity_Type_Account_Metadata, model::Entity_Type_Token_Metadata, model::Entity_Type_Namespace_Metadata };
			}
