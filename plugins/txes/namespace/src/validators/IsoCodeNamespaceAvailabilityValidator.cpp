...
namespace bitxorcore { namespace validators {
	...
	using Notification = model::IsoCodeNamespaceNotification;

	DECLARE_STATEFUL_VALIDATOR(IsoCodeNamespaceAvailability, Notification)(uint8_t maxNamespaceDepth) {
		return MAKE_STATEFUL_VALIDATOR(IsoCodeNamespaceAvailability, ([maxNamespaceDepth](
