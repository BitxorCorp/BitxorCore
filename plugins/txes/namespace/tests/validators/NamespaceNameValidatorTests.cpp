...
#define RESERVED_TEST_CLASS NamespaceReservedNameValidatorTests
	...
	TEST(RESERVED_TEST_CLASS, SuccessWhenValidatingReservedRootNamespaceNamesUsedByGenesis) {
		for (const auto& name : Reserved_Names)
	...
	TEST(RESERVED_TEST_CLASS, SuccessWhenValidatingChildNamespaceWithReservedParentNamespaceNamesUsedByGenesis) {
		for (const auto& name : Reserved_Names)
