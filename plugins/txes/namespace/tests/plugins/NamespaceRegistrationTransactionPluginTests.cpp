...
#define TEST_CLASS NamespaceRegistrationTransactionPluginTests
	...
	// region publish - root genesis signer
	...
	PLUGIN_TEST(CanPublishAllNotificationsInCorrectOrderWhenGenesisRootRegistration) {
		// Arrange:
	...
	PLUGIN_TEST(CanPublishAllNotificationsWhenGenesisRootRegistration) {
		// Arrange:
		auto config = CreateRentalFeeConfiguration(Amount(987), Amount(777));
	...
	// region publish - root genesis not signer (finite duration)

	PLUGIN_TEST(CanPublishAllNotificationsInCorrectOrderWhenNotGenesisRootRegistrationWithFiniteDuration) {
		// Arrange:
		auto config = CreateRentalFeeConfiguration(Amount(987), Amount(777));
	...
	PLUGIN_TEST(CanPublishAllNotificationsWhenNotGenesisRootRegistrationWithFiniteDuration) {
		// Arrange:
		auto config = CreateRentalFeeConfiguration(Amount(987), Amount(777));
	...
	// region publish - root genesis not signer (eternal duration)

	PLUGIN_TEST(CanPublishAllNotificationsInCorrectOrderWhenNotGenesisRootRegistrationWithEternalDuration) {
		// Arrange:
		auto config = CreateRentalFeeConfiguration(Amount(987), Amount(777));
	...
	PLUGIN_TEST(CanPublishAllNotificationsWhenNotGenesisRootRegistrationWithEternalDuration) {
		// Arrange:
		auto config = CreateRentalFeeConfiguration(Amount(987), Amount(777));
	...
	// region publish - child genesis signer
	...
	PLUGIN_TEST(CanPublishAllNotificationsInCorrectOrderWhenGenesisChildRegistration) {
		// Arrange:
		auto config = CreateRentalFeeConfiguration(Amount(987), Amount(777));
	...
	PLUGIN_TEST(CanPublishAllNotificationsWhenGenesisChildRegistration) {
		// Arrange:
		auto config = CreateRentalFeeConfiguration(Amount(987), Amount(777));
	...
	// region publish - child genesis not signer

	PLUGIN_TEST(CanPublishAllNotificationsInCorrectOrderWhenNotGenesisChildRegistrationWithFiniteDuration) {
		// Arrange:
		auto config = CreateRentalFeeConfiguration(Amount(987), Amount(777));
	...
	PLUGIN_TEST(CanPublishAllNotificationsWhenNotGenesisChildRegistrationWithFiniteDuration) {
		// Arrange:
		auto config = CreateRentalFeeConfiguration(Amount(987), Amount(777));
