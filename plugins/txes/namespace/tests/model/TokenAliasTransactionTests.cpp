...
#define TEST_CLASS TokenAliasTransactionTests

	using TransactionType = TokenAliasTransaction;

	// region size + alignment + properties

#define TRANSACTION_FIELDS FIELD(NamespaceId) FIELD(TokenId) FIELD(AliasAction)
...
#undef FIELD
		...
		void AssertTransactionHasExpectedProperties() {
			// Assert:
			EXPECT_EQ(Entity_Type_Alias_Token, T::Entity_Type);
...
#undef TRANSACTION_FIELDS
	...
	ADD_BASIC_TRANSACTION_SIZE_PROPERTY_TESTS(TokenAlias)
