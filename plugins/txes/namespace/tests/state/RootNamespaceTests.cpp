...
#define TEST_CLASS RootNamespaceTests
	...
	TEST(TEST_CLASS, CannotGetUnknownChild) {
		...
		// Act + Assert:
		EXPECT_THROW(root.child(NamespaceId(1337)), bitxorcore_invalid_argument);
	}
	...
	TEST(TEST_CLASS, CannotAddSameChildTwice) {
		...
		// Act + Assert:
		EXPECT_THROW(root.add(Namespace(test::CreatePath({ 123, 124 }))), bitxorcore_invalid_argument);
	}
	...
	TEST(TEST_CLASS, CannotAddChildWithUnknownParent) {
		...
		EXPECT_THROW(root.add(Namespace(test::CreatePath({ 123, 129, 130 }))), bitxorcore_invalid_argument);
	}
	...
	TEST(TEST_CLASS, CannotAddChildWithIncorrectPath) {
		...
		EXPECT_THROW(root.add(Namespace(test::CreatePath({ 123, 128, 130 }))), bitxorcore_invalid_argument);
	}
	...
	TEST(TEST_CLASS, CannotAddChildWithDifferentRoot) {
		...
		EXPECT_THROW(root.add(Namespace(test::CreatePath({ 122, 124, 136 }))), bitxorcore_invalid_argument);
	}
	...
	TEST(TEST_CLASS, CannotRemoveUnknownChild) {
		...
		// Act + Assert:
		EXPECT_THROW(root.remove(NamespaceId(1337)), bitxorcore_invalid_argument);
	}
	...
	TEST(TEST_CLASS, CannotRemoveChildWithDescendents) {
		...
		// Act + Assert:
		EXPECT_THROW(root.remove(NamespaceId(124)), bitxorcore_invalid_argument);
	}
	...
	TEST(TEST_CLASS, CannotGetAliasForUnknownNamespace) {
		...
		// Act + Assert:
		EXPECT_THROW(root.alias(NamespaceId(127)), bitxorcore_invalid_argument);
	}
	...
	TEST(TEST_CLASS, CanSetRootAlias) {
		...
		// Act:
		root.setAlias(NamespaceId(123), NamespaceAlias(TokenId(444)));
	...
	TEST(TEST_CLASS, CanSetChildAlias) {
		...
		// Act:
		root.setAlias(NamespaceId(125), NamespaceAlias(TokenId(444)));
	...
	TEST(TEST_CLASS, CannotSetAliasForUnknownNamespace) {
		...
		// Act + Assert:
		EXPECT_THROW(root.setAlias(NamespaceId(127), NamespaceAlias(TokenId(444))), bitxorcore_invalid_argument);
	}
