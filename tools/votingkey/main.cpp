...
#include "bitxorcore/crypto_voting/BmPrivateKeyTree.h"
#include "bitxorcore/io/FileStream.h"
#include "bitxorcore/model/StepIdentifier.h"
#include "bitxorcore/exceptions.h"
#include <filesystem>
#include <iostream>
#include <string>

namespace bitxorcore { namespace tools { namespace votingkey {
		...
		private:
			BmPublicKey generateTree(crypto::VotingKeyPair&& keyPair) {
				if (std::filesystem::exists(m_filename))
					BITXORCORE_THROW_RUNTIME_ERROR("voting private key tree file already exits");
...
int main(int argc, const char** argv) {
	bitxorcore::tools::votingkey::VotingKeyTool tool;
