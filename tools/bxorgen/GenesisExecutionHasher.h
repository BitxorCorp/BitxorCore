...
#pragma once
#include "blockhashes/GenesisBlockHashesCalculator.h"
#include <string>
...
namespace bitxorcore { namespace tools { namespace bxorgen {
	...
	/// Genesis block execution dependent hashes information.
	struct GenesisExecutionHashesDescriptor : public BlockExecutionHashesInfo {
		/// Textual summary including sub cache hashes.
		std::string Summary;
	};

	/// Calculates and logs the genesis block execution dependent hashes after executing genesis \a blockElement
