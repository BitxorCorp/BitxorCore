...
namespace bitxorcore {
	...
	namespace tools { namespace bxorgen { struct GenesisConfiguration; } }
}

namespace bitxorcore { namespace tools { namespace bxorgen {

	/// Saves genesis \a blockElement according to \a config.
	void SaveGenesisBlockElement(const model::BlockElement& blockElement, const GenesisConfiguration& config);

	/// Finalizes genesis \a blockElement according to \a config.
