...
#define PACKET_TYPE_LIST \
	...
	\
	/* Token state path has been requested by a client. */ \
	ENUM_VALUE(Token_State_Path, FACILITY_BASED_CODE(0x200, Token)) \
	\
	...
	\
	/* Token restrictions state path has been requested by a client. */ \
	ENUM_VALUE(Token_Restrictions_State_Path, FACILITY_BASED_CODE(0x200, RestrictionToken)) \
	\
	...
	\
	/* Token infos have been requested by a client. */ \
	ENUM_VALUE(Token_Infos, FACILITY_BASED_CODE(0x400, Token)) \
	\
	...
	\
	/* Token restrictions infos have been requested by a client. */ \
	ENUM_VALUE(Token_Restrictions_Infos, FACILITY_BASED_CODE(0x400, RestrictionToken))
