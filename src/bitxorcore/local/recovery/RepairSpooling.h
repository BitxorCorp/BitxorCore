...
namespace bitxorcore { namespace config { class BitxorCoreDataDirectory; } }

namespace bitxorcore { namespace local {

	/// Repairs bitxorcore spooling folders inside \a dataDirectory given last server commit operation step that succeeded (\a commitStep).
