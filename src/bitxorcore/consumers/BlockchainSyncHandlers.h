...
namespace bitxorcore { namespace consumers {
	...
	public:
		...
		using DifficultyCheckerFunc = predicate<const std::vector<const model::Block*>&, const cache::BitxorCoreCache&>;
		...
		using PreStateWrittenFunc = consumer<const cache::BitxorCoreCacheDelta&, Height>;
