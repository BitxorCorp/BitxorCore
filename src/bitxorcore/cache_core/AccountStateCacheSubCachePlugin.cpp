	...
	namespace {
		...
		public:
			void saveAll(const BitxorCoreCacheView&, io::OutputStream&) const override {
				BITXORCORE_THROW_INVALID_ARGUMENT("AccountStateCacheSummaryCacheStorage does not support saveAll");
			}
		...
		public:
			void saveAll(const BitxorCoreCacheView& cacheView, io::OutputStream& output) const override {
