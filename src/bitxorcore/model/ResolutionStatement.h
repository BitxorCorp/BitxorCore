...
#pragma pack(pop)
	...
	/// Token resolution statement.
	using TokenResolutionStatement = ResolutionStatement<UnresolvedTokenId, TokenId, Receipt_Type_Token_Alias_Resolution>;
	extern template class ResolutionStatement<UnresolvedTokenId, TokenId, Receipt_Type_Token_Alias_Resolution>;
}}
