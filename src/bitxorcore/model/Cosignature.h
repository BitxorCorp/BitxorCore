...
#pragma pack(push, 1)
	...
	public:
		...
		Cosignature(const Key& signerPublicKey, const bitxorcore::Signature& signature)
				: Version(0)
	...
	public:
		...
		DetachedCosignature(const Key& signerPublicKey, const bitxorcore::Signature& signature, const Hash256& parentHash)
