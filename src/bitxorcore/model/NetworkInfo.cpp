...
namespace bitxorcore { namespace model {
	...
	NetworkInfo::NetworkInfo(
			...
			, GenesisSignerPublicKey(genesisSignerPublicKey)
	...
	Address GetGenesisSignerAddress(const NetworkInfo& networkInfo) {
		return PublicKeyToAddress(networkInfo.GenesisSignerPublicKey, networkInfo.Identifier);
	}
