...
namespace bitxorcore { namespace model {
	...
	void BlockStatementBuilder::addResolution(UnresolvedTokenId unresolved, TokenId resolved) {
		AddResolution(m_pStatement->TokenResolutionStatements, m_activeSource, unresolved, resolved);
	}
