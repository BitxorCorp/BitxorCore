...
#pragma once
#include "bitxorcore/utils/ClampedBaseValue.h"
#include <type_traits>

namespace bitxorcore { namespace utils { namespace traits {

	// region is_scalar

	/// If T is a standard scalar type or a bitxorcore scalar type, this struct will provide the member constant value equal to \c true.
	...
	/// \c true if T is a standard scalar type or a bitxorcore scalar type, \c false otherwise.
	template<typename T>
	...
	/// If T is a standard pod type or a bitxorcore scalar type and is not a pointer type, this struct will provide the member constant
	...
	/// \c true if T is a standard pod type or a bitxorcore scalar type and is not a pointer type, \c false otherwise.
	template<typename T>
