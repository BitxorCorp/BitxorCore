...
namespace bitxorcore { namespace utils {
	...
	bool TryParseValue(const std::string& str, TokenId& parsedValue) {
		return TryParseCustomUnsignedIntHexValue<TokenId::ValueType>([](auto raw) { return TokenId(raw); }, str, parsedValue);
	}
