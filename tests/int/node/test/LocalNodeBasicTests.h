...
namespace bitxorcore { namespace test {
	...
	public:
		...
		// region basic tests - genesis subscriptions
	...
	public:
		static void AssertLocalNodeTriggersGenesisSubscribersAtHeightOne() {
			// Arrange:
			...
			auto dataDirectory = config::BitxorCoreDataDirectory(context.dataDirectory());
		...
		static void AssertLocalNodeDoesNotTriggerGenesisSubscribersAtHeightTwo() {
		...
		static void AssertLocalNodeCannotBootWhenCacheAndStorageHeightsAreInconsistent() {
			...
			// Act + Assert:
			EXPECT_THROW(boot(), bitxorcore_runtime_error);
		}
...
#define DEFINE_LOCAL_NODE_BASIC_TESTS(TRAITS_NAME) \
	...
	MAKE_LOCAL_NODE_BASIC_TEST(TRAITS_NAME, LocalNodeTriggersGenesisSubscribersAtHeightOne) \
	MAKE_LOCAL_NODE_BASIC_TEST(TRAITS_NAME, LocalNodeDoesNotTriggerGenesisSubscribersAtHeightTwo) \
