...
#define TEST_CLASS LocalNodeSyncAccountRestrictionIntegrityTests
	...
	namespace {
		...
		Hash256 GetComponentStateHash(const test::PeerLocalNodeTestContext& context) {
			// { AccountState, Namespace, Token, *AccountRestriction* }
	...
	NO_STRESS_TEST(TEST_CLASS, CanAddAccountRestriction) {
		// Arrange:
		test::StateHashDisabledTestContext context(test::NonGenesisTransactionPlugins::Restriction_Account);
	...
	NO_STRESS_TEST(TEST_CLASS, CanAddAccountRestrictionWithStateHashEnabled) {
		// Arrange:
		test::StateHashEnabledTestContext context(test::NonGenesisTransactionPlugins::Restriction_Account);
	...
	NO_STRESS_TEST(TEST_CLASS, CanRemoveAccountRestrictionWithStateHashEnabled) {
		...
		// - restriction cache merkle root is initially zero (no restrictions in genesis)
