...
#include "bitxorcore/cache_db/RdbColumnContainer.h"
#include "bitxorcore/cache_db/RocksInclude.h"
...
#define TEST_CLASS RdbColumnContainerTests
	...
	TEST(TEST_CLASS, PropFailsWhenPropertyNameIsTooLong) {
		...
		// Act + Assert:
		uint64_t value;
		EXPECT_THROW(container.prop("12345678", value), bitxorcore_invalid_argument);
	}
	...
	TEST(TEST_CLASS, SetPropFailsWhenPropertyNameIsTooLong) {
		...
		// Act:
		EXPECT_THROW(container.setProp("12345678", property), bitxorcore_invalid_argument);
	}
