...
namespace bitxorcore { namespace test {
	...
	private:
		...
		static void AssertInputT(
			...
			EXPECT_THROW(input.transactions(), bitxorcore_runtime_error);
	...
	private:
		...
		static void AssertInputT(
			...
			EXPECT_EQ(expectedInputSource, input.source());
			EXPECT_THROW(input.blocks(), bitxorcore_runtime_error);
