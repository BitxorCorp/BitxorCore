...
#define TEST_CLASS BrokerTests
	...
	public:
		void boot() {
			auto config = test::CreatePrototypicalBitxorCoreConfiguration(dataDirectory().rootDir().str());
