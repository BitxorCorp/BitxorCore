...
#include "bitxorcore/local/recovery/RepairState.h"
...
#define TEST_CLASS RepairStateTests
	...
	namespace {
		...
		public:
			void repair() {
				return RepairState(m_dataDirectory.spoolDir(Queue_Name), m_bitxorcoreCache, m_registeredSubscriber, m_repairSubscriber);
			}
