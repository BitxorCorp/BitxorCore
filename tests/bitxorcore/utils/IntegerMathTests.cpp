...
#define TEST_CLASS IntegerMathTests
	...
	TEST(TEST_CLASS, Log2TimesPowerOfTwoThrowsForZero) {
		EXPECT_THROW(Log2TimesPowerOfTwo(0, 0), bitxorcore_invalid_argument);
		EXPECT_THROW(Log2TimesPowerOfTwo(0, 1), bitxorcore_invalid_argument);
		EXPECT_THROW(Log2TimesPowerOfTwo(0, 10), bitxorcore_invalid_argument);
		EXPECT_THROW(Log2TimesPowerOfTwo(0, 54), bitxorcore_invalid_argument);
	}
