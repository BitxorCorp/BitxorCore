...
#define TEST_CLASS BlockStatisticCacheTests
	...
	TEST(TEST_CLASS, InsertThrowsWhenElementHasUnexpectedHeight) {
		...
		// Act + Assert:
		EXPECT_THROW(delta->insert(CreateStatistic(1)), bitxorcore_invalid_argument);
		EXPECT_THROW(delta->insert(CreateStatistic(17)), bitxorcore_invalid_argument);
	}
	...
	TEST(TEST_CLASS, RemoveThrowsWhenElementHasUnexpectedHeight) {
		...
		// Act + Assert:
		EXPECT_THROW(delta->remove(CreateStatistic(5)), bitxorcore_invalid_argument);
		EXPECT_THROW(delta->remove(CreateStatistic(17)), bitxorcore_invalid_argument);
	}
	...
	TEST(TEST_CLASS, RemoveThrowsWhenCacheIsEmpty) {
		...
		// Act + Assert:
		EXPECT_THROW(delta->remove(CreateStatistic(5)), bitxorcore_runtime_error);
		EXPECT_THROW(delta->remove(CreateStatistic(17)), bitxorcore_runtime_error);
	}
...
#define VIEW_OR_DELTA_TEST(TEST_NAME) \
	...
	VIEW_OR_DELTA_TEST(StatisticsThrowsWhenCacheIsEmpty) {
		...
		// Act + Assert:
		EXPECT_THROW(view->statistics(Height(78), 35), bitxorcore_runtime_error);
	}
	...
	VIEW_OR_DELTA_TEST(StatisticsThrowsWhenHeightOrCountIsZero) {
		...
		// Act + Assert:
		EXPECT_THROW(view->statistics(Height(0), 1), bitxorcore_invalid_argument);
		EXPECT_THROW(view->statistics(Height(50), 0), bitxorcore_invalid_argument);
	}
	...
	VIEW_OR_DELTA_TEST(StatisticsThrowsWhenStatisticWithSpecifiedHeightIsNotFound) {
		...
		// Act + Assert:
		EXPECT_THROW(view->statistics(Height(101), 1), bitxorcore_invalid_argument);
		EXPECT_THROW(view->statistics(Height(102), 1), bitxorcore_invalid_argument);
		EXPECT_THROW(view->statistics(Height(1000), 1), bitxorcore_invalid_argument);
	}
