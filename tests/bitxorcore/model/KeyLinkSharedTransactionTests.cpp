...
#include "bitxorcore/model/KeyLinkSharedTransaction.h"
...
#pragma pack(push, 1)
	...
	namespace {
		...
		// use a non-key type (TokenId) in tests
		template<typename THeader>
		struct KeyLinkSharedTransactionBody : public BasicKeyLinkTransactionBody<THeader, TokenId, static_cast<EntityType>(17)> {};
