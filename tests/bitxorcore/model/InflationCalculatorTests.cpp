...
#define TEST_CLASS InflationCalculatorTests
	...
	TEST(TEST_CLASS, CannotAddInflationEntryAtHeightZero) {
		...
		// Act + Assert:
		EXPECT_THROW(calculator.add(Height(0), Amount(123)), bitxorcore_invalid_argument);
	}
	...
	TEST(TEST_CLASS, CannotAddInflationEntryWhenHeightIsEqualToLastEntryHeight) {
		...
		// Assert:
		EXPECT_THROW(calculator.add(Height(15), Amount(234)), bitxorcore_invalid_argument);
	}
	...
	TEST(TEST_CLASS, CannotAddInflationEntryWhenHeightIsLessThanLastEntryHeight) {
		...
		// Assert:
		EXPECT_THROW(calculator.add(Height(5), Amount(456)), bitxorcore_invalid_argument);
		EXPECT_THROW(calculator.add(Height(10), Amount(567)), bitxorcore_invalid_argument);
		EXPECT_THROW(calculator.add(Height(14), Amount(678)), bitxorcore_invalid_argument);
	}
