...
#define TEST_CLASS BlockUtilsTests
	...
	TEST(TEST_CLASS, CalculateBlockTypeFromHeight_HeightOne_MustBeGenesisBlock) {
		EXPECT_EQ(Entity_Type_Block_Genesis, CalculateBlockTypeFromHeight(Height(1), 50));

		EXPECT_EQ(Entity_Type_Block_Genesis, CalculateBlockTypeFromHeight(Height(1), 123));
	}
