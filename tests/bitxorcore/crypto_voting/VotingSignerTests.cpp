...
#include "bitxorcore/crypto_voting/VotingSigner.h"
	...
	namespace {
		...
		public:
			...
			static auto MakeNonCanonical(const Signature& canonicalSignature) {
				...
				auto ed25519NonCanonicalSignature = canonicalSignature.copyTo<bitxorcore::Signature>();
				test::ScalarAddGroupOrder(ed25519NonCanonicalSignature.data() + bitxorcore::Signature::Size / 2);

				// preserve custom signature padding
				auto nonCanonicalSignature = ed25519NonCanonicalSignature.copyTo<Signature>();
				std::memcpy(
						nonCanonicalSignature.data() + bitxorcore::Signature::Size,
						canonicalSignature.data() + bitxorcore::Signature::Size,
						Signature::Size - bitxorcore::Signature::Size);
