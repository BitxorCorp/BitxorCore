...
#include "bitxorcore/cache/CacheStorageAdapter.h"
#include "bitxorcore/cache/BitxorCoreCache.h"
#include "bitxorcore/cache/SubCachePluginAdapter.h"
#include "tests/bitxorcore/cache/test/CacheSerializationTestUtils.h"
...
#define TEST_CLASS CacheStorageAdapterTests
	...
	namespace {
		void AssertCanSaveAllViaCacheStorageAdapter(uint64_t numEntries) {
			...
			BitxorCoreCache bitxorcoreCache(std::move(subCaches));
