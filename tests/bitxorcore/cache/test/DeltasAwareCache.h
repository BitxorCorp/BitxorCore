...
#include "bitxorcore/deltaset/DeltaElementsMixin.h"
...
namespace bitxorcore { namespace test {
	...
	public:
		CacheViewType createView() const {
			BITXORCORE_THROW_RUNTIME_ERROR("createView - not supported");
		}
		...
		CacheDeltaType createDetachedDelta() const {
			BITXORCORE_THROW_RUNTIME_ERROR("createDetachedDelta - not supported");
		}
	...
	// wrap BasicDeltasAwareCache in cache::SynchronizedCache so it can be registered with BitxorCoreCache
