...
#include "bitxorcore/crypto/OpensslContexts.h"
...
#define TEST_CLASS OpensslContextsTests
	...
	TEST(TEST_CLASS, Digest_CanDispatchFailure) {
		...
		// Act + Assert:
		EXPECT_THROW(context.dispatch(EVP_DigestInit_ex, nullptr, nullptr), bitxorcore_runtime_error);
	}
	...
	TEST(TEST_CLASS, Cipher_CanDispatchFailure) {
		...
		// Act + Assert:
		EXPECT_THROW(context.dispatch(EVP_DecryptInit_ex, nullptr, nullptr, key.data(), iv.data()), bitxorcore_runtime_error);
	}
