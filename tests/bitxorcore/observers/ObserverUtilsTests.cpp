...
#define TEST_CLASS ObserverUtilsTests
	...
	namespace {
		...
		// 1. wrap BasicTouchableCache in cache::SynchronizedCache so it can be registered with BitxorCoreCache
		...
		cache::BitxorCoreCache CreateSimpleBitxorCoreCache() {
			cache::BitxorCoreCacheBuilder builder;
