...
namespace bitxorcore { namespace test {
	...
	std::unique_ptr<model::BlockStatement> GenerateRandomStatements(
		...
		GenerateRandomStatements(pBlockStatement->TokenResolutionStatements, numStatements[2], constraints);
	...
	namespace {
		void AssertKeys(const UnresolvedTokenId& lhs, const UnresolvedTokenId& rhs, const std::string& message) {
	...
	void AssertEqual(const model::BlockStatement& expectedBlockStatement, const model::BlockStatement& blockStatement) {
		...
		AssertStatements(expectedBlockStatement.TokenResolutionStatements, blockStatement.TokenResolutionStatements);
