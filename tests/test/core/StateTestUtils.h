...
namespace bitxorcore { namespace test {
	...
	/// Creates random bitxorcore state.
	state::BitxorCoreState CreateRandomBitxorCoreState();

	/// Creates deterministic bitxorcore state.
	state::BitxorCoreState CreateDeterministicBitxorCoreState();

	/// Asserts that bitxorcore state \a actual is equal to \a expected with optional \a message.
